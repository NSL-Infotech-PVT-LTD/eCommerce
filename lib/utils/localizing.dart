...
class MyLocalization{
  ...
  Future load() async{
    ...
    String jsonStringValue = await rootBundle.loadString("lib/utils/${locale.languageCode}.json");
  ...
  //stat
  static const LocalizationsDelegate<MyLocalization> delegate = _MyLocalizationDelegate();
}
