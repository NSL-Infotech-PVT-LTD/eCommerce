...
class SwipeButtonB extends StatefulWidget {
  final Widget child;
  final Widget? thumb;
...
class _SwipeState extends State<SwipeButtonB> {
    ...
    return Container(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: swipeColor),
          color: trackColor,
        ),
