...
class _SigninState extends State<Signin> {
  ...
  bool _loading = false;
  Map facebookdata = {};
  TextEditingController facebookEmail = TextEditingController();
                        ...
                        GestureDetector(
                          onTap: () {
                            facebooksignWithApi(
                                ...
                                email: facebookEmail.text,
                                fbId: facebookdata["picture"]["data"]["id"]
                                    .toString(),
                                profileImage: facebookdata["picture"]["data"]
                                        ["url"]
                                    .toString(),
                                deviceToken: "Token",
                                deviceType:
                            ...
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Container(
                                      child: Image.asset(Images.appleIcon)),
                                  SizedBox(
