...
class MobileNumberScreen extends StatefulWidget {
  ...
  const MobileNumberScreen(
      {Key? key, @required this.bodyData, @required this.type})
      : super(key: key);
...
class _MobileNumberScreenState extends State<MobileNumberScreen> {
  ...
  _signinWithphone() async {
    ...
    if (net != false) {
      if (widget.type == 2) {
        await googleLogin(phoneBody: data).then((res) {
          setState(() {
            _loading = false;
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    "${getTranslated(context, "registerMobile")}",
            ...
            //       text:
            //           "${getTranslated(context, "YouHaveToRegisteryourMobileNumberforSignIn")}", // Strings.byContinuingYouAgreetoOur,
            //       style: TextStyle(
            //           fontFamily: Fonts.dmSansMedium,
