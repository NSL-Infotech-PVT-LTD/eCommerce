        ...
        actions: [
          Padding(
            ...
            child: Align(
                ...
                }, child: SvgPicture.asset(Strings.assetsSvgIcons + 'place_holder.svg'))),
          ),
        ],
        centerTitle: true,
        title: Container(
                  ...
                  child: Column(
                    ...
                    children:[
                      Container(
                          ...
                          child: Text("ef",style: TextStyle(color: Colors.black),softWrap: true, )),
                      SizedBox(height: SizeConfig.screenHeight * 0.01,),
                      Text("Edit profile",style: TextStyle(color: Colors.black,fontSize:13, decoration: TextDecoration.underline,),)
                    ],),
                ),
              ],),],
          ),
